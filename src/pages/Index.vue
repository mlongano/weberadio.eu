  ...
  <div class="flex flex-col lg:flex-row justify-center w-9/12 mx-auto mt-10">
      ...
      <div class="bg-black bg-opacity-70 text-white px-4 py-4 text-justify w-auto lg:w-6/12 shadow-xl">
        ...
        <p>
          ...
          <ul class="list-disc list-inside">
            <li>l’Istituto Tecnico Tecnologico &quot;<b>Marconi</b>&quot; di Rovereto (capofila),</li>
            <li>Istituto Tecnico Economico &quot;<b>A. Tambosi</b>&quot; di Trento e Istituto di Istruzione &quot;</li>
            <li>&quot;<b>La Rosa Bianca</b>&quot; di Cavalese/Predazzo.</li>
          </ul>
        </p>
        <p>ogni istituto costituisce una redazione autonoma con dispositivi
    ...
    >
      <span
        >Photo by
        <a
          href="https://unsplash.com/@jasonrosewell?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText"
          >Jason Rosewell</a
        >
        on
        <a
